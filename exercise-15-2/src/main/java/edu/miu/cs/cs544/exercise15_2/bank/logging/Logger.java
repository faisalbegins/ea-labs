package edu.miu.cs.cs544.exercise15_2.bank.logging;
...
public class Logger {
    ...
    @After("execution(public void edu.miu.cs.cs544.exercise15_2.bank.jms.JMSSender.sendJMSMessage(..)) && args(message)")
